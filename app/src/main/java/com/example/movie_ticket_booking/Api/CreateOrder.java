package com.example.movie_ticket_booking.Api;

import com.example.movie_ticket_booking.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = com.zlpdemo.merchantDemo.Api.HttpProvider.sendPost(AppInfo.URL_CREATE_ORDER, formBody);
        return data;
    }
}
