package com.example.movie_ticket_booking.Helper.HMac;
...
public class HMacUtil {
    ...
    public static String HMacHexStringEncode(final String algorithm, final String key, final String data) {
        ...
        return com.example.movie_ticket_booking.Helper.HMac.HexStringUtil.byteArrayToHexString(hmacEncodeBytes);
    }
}
